...
if __name__ == "__main__":
    ...
    parser.add_argument("--chole_path", type=str, default="data/data_chole/state_trajectories_denoised_chole.json")
    parser.add_argument("--pan_path", type=str, default="data/data_pan/state_trajectories_denoised_pan.json")
    parser.add_argument("--diver_path", type=str, default="data/data_diver/state_trajectories_denoised_diver.json")
