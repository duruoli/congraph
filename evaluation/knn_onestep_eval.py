"""knn_onestep_eval.py — 1-step KNN counterfactual (speed, accuracy, cost, burden)
...
Usage
-----
  python evaluation/knn_onestep_eval.py
  python evaluation/knn_onestep_eval.py --alphas 0.0,0.5,1.0 --plot --plot-dir results/figs/cb
  python evaluation/knn_onestep_eval.py --csv results/knn_cost_burden.csv
"""
...
from evaluation.test_burden_cost import TEST_COST, TEST_BURDEN
