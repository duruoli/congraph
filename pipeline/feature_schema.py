...
# lab_itemids                MIMIC labevents itemid 键（来自 CSV「Laboratory Tests」
#                            JSON），用于按实际化验项估算 Lab_Panel 费用；与
#                            tests_done 独立，仿真解码时从基线状态保留
...
def default_features() -> dict:
    ...
    return {
        ...
        "lab_itemids": [],  # list[str]; MIMIC itemids present in Laboratory Tests JSON
    }
